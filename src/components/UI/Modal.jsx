...
import imgUrl from "../../assets/data/portfolioData";
import siteUrl from "../../assets/data/portfolioData";
      ...
      <div className="max-w-[60px] absolute top-1/2 left-1/2 z-20 bg-white rounded-[8px] transform-translate-x-1/2 -translate-y-1/2 p-5">
        <div>
          ...
          <a href={portfolio?.siteUrl}>
            <button className="bg-primaryColor text-white py-2 px-4 my-8 rounded-[8px] fony-[500] hover:bg-headingColor ease-in duration-300">
              live Site
            </button>
          </a>
        </div>
        <button
          ...
          className="w-[1.8rem] h-[1.8rem] bg-[white] absolute top-[1.7 rem] right-[1.7 rem] text-[25px] flex items-center justify-center rounded-[3px] leading-[0] cursor-pointer "
        ></button>
      </div>
    </div>
  );
